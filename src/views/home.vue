  ...
  <div class="container">
    <div class="upload">
      <div class="l-con">
        ...
        <el-tag class="el-tag--mini" type="success">测试一</el-tag>
        <el-tag class="el-tag--medium " type="success">测试二</el-tag>
        <el-tag type="success" size="mini">测试三</el-tag>
        <el-tag  type="success" size="medium">测试四</el-tag>
      </div>
      <div class="r-con">
